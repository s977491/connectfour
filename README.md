...
A Connect Four game implementation.
...
1) run below to build the project with test run
mvn clean package assembly:single

2) go to the target folder, find the generated jar (connectfour-1.0.0-jar-with-dependencies.jar)
java -jar connectfour-1.0.0-jar-with-dependencies.jar
